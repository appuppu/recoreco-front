...
struct ReportChannelView: View {
    ...
    var body: some View {
        ...
        .alert("報告完了", isPresented: $showingSuccessAlert) {
            ...
            Text("チャンネル「\(channelName)」を報告しました")
        }
    ...
    private func submitReport() async {
        ...
        do {
            try await FirestoreReportManager.shared.reportChannel(
                channelId: channelId,
            ...
            print("❌ Failed to report channel: \(error)")
            isSubmitting = false
